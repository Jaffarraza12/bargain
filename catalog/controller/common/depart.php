<?php
class ControllerCommonDepart extends Controller {
	public function index() {
        ...
        foreach ($results as $result){
            $data['categories'][] = array(
                ...
                'href' => $this->url->link('product/category', 'path=' . $result['category_id'].'&did='.$result['depart_id'] . $url)
            );
        }

        $data['did'] = $did;
        $data['heading'] = 'Bargain Center';
