...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		//$this->document->setTitle($this->language->get('heading_title'));
                $this->document->setTitle("Contact Us - We are Here to Help - Bargain.pk");
                $this->document->setDescription("Have a question? We are here to answer all your queries and questions quick. We provide solutions with our answer that make your online shopping easy and smooth.");
