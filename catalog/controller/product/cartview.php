<?php
class ControllerProductCartView extends Controller {
	private $error = array();
		...
		if ($product_info) {
            ...
            $option_data = array();
                ...
                foreach ($product['option'] as $option) {
                    ...
                    if ($option['OPimage']){
                        $image = $this->model_tool_image->resize($option['OPimage'], 228, 228);
           ...
           if($product_info['depart_id'] == 8) {
               $this->response->setOutput($this->load->view('product/cartview2', $data));
           } else {
               $this->response->setOutput($this->load->view('product/cartview', $data));
           }
       } else {
