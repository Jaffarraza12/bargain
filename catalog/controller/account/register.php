...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
        ...
        $this->document->addScript('catalog/view/theme/ceptz/js/account.js');

        $this->load->model('account/customer');

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$customer_id = $this->model_account_customer->addCustomer($this->request->post);
            $refno = $this->addAccount($this->request->post);
            $this->model_account_customer->CustomerCRMref($refno,$customer_id);
	...
	private function validate() {
		...
		if ($this->model_account_customer->getTotalCustomersByEmailNGuest($this->request->post['email'])) {
