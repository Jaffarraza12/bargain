<?php
class ControllerCommonKids extends Controller {
	public function index() {

	 	$this->document->setTitle("Kids Corner - Kids Clothing and toys collection buy Online In Pakistan | Bargain.Pk");
		$this->document->setDescription("Buy Clothing & Accessories at Best Price in Pakistan!");
        ...
        $latest_products =  $this->model_catalog_product->getLatestProductFromDepartment(9);
        $products = array();
		...
		$this->response->setOutput($this->load->view('common/kids', $data));
	}
}
