...
class ModelCheckoutOrder extends Model {
	...
	public function getCity($city_id){
       $query = $this->db->query(" SELECT * FROM `oc_zone_city` WHERE `zone_city_id`   = '" . (int)$city_id . "' ");
    ...
    public function getZoneName($zone_id){
        $query = $this->db->query(" SELECT * FROM `oc_zone` WHERE `zone_id`   = '" . (int)$zone_id . "' ");
    ...
    public function getGuest($email){
        $guest_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "guest_user` g WHERE g.email = '" . $email . "'");

       return  $guest_query->num_rows;



    }

    public function getGuestCRM($crm){
        $guest_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "guest_user` g WHERE g.email = '" . $crm . "'");
        return  $guest_query->row['crm'];
    }


    public function addGuest($data){
            $this->db->query("INSERT INTO `" . DB_PREFIX . "guest_user` SET `name` = '" . $this->db->escape($data['name']) . "', email = '" . $this->db->escape($data['email']) . "', phone = '" . $this->db->escape($data['phone']) . "',`shipping_address` = '" . $this->db->escape($data['shipping_address']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_state = '" . $this->db->escape($data['shipping_state']) . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', crm = '" . $this->db->escape($data['crm']) . "', sts = '" . $data['sts'] . "', mts = '" . $data['mts'] . "'");

    }
    public function editGuest($data,$email){
            $this->db->query("UPDATE `" . DB_PREFIX . "guest_user` SET `name` = '" . $this->db->escape($data['name']) . "', email = '" . $this->db->escape($data['email']) . "', phone = '" . $this->db->escape($data['phone']) . "',`shipping_address` = '" . $this->db->escape($data['shipping_address']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_state = '" . $this->db->escape($data['shipping_state']) . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', crm = '" . $this->db->escape($data['crm']) . "', sts = '" . $data['sts'] . "', mts = '" . $data['mts'] . "' WHERE `email` = '".$email."'");

    }


    public function getAccountCRM($id){
        $guest_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "customer` c WHERE c.customer_id = '" . $id. "'");
        return  $guest_query->row['ref-no'];
    }


    public function getOptionImage($povid){
          $pov = $this->db->query(" SELECT * FROM `" . DB_PREFIX . "product_option_value` WHERE `product_option_value_id` = '".$povid."' ");
          return $pov->row['image'];
